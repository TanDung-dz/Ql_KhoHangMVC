...
{
    public class KhachHangWebController : Controller
    {
        private readonly KhachHangService _khachHangService;
        private readonly LoaiKhachHangService _loaiKhachHangService;

        public KhachHangWebController(KhachHangService khachHangService, LoaiKhachHangService loaiKhachHangService)
        {
