...
namespace Ql_KhoHang.Controllers
{
    public class LoaiSanPhamController : Controller
    {
        ...
        {
            SetUserClaims();
            IEnumerable<LoaiSanPhamDto> allCategories;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(LoaiSanPhamDto newCategory)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, LoaiSanPhamDto category)
        {
            if (ModelState.IsValid)
            {
