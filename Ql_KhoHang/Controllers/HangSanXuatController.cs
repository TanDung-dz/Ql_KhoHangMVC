...
namespace Ql_KhoHang.Controllers
{
    public class HangSanXuatController : Controller
    {
        ...
        public HangSanXuatController(HangSanXuatService hangSanXuatService)
        {
        ...
        {
            SetUserClaims();
            IEnumerable<HangSanXuatDto> allManufacturers;
        ...
        [HttpPost]
        public async Task<IActionResult> Create(HangSanXuatDto newManufacturer)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit(int id, HangSanXuatDto manufacturer)
        {
            if (ModelState.IsValid)
            {
